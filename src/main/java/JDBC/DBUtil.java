...
public class DBUtil {
     ...
     * @throws SQLException
     */
    public static List<Map<String, Object>> executeQuery(Connection con,
                                                         String sql) throws
            SQLException {
     ...
     * @throws SQLException
     */
    public static List<Object> executeQuery(Connection con, String sql,
     ...
     * @throws SQLException
     */
    public static List<Map<String, Object>> getListFromRs(ResultSet rs)
            throws SQLException {
        ...
        while (rs.next()) {
            ...
            for (i = 0; i < columns; i++) {
                map.put(md.getColumnName(i + 1), getValueByType(rs, md
                        .getColumnType(i + 1), md.getColumnName(i + 1)));
            }
            list.add(map);
        }
        return list;
     ...
     * @throws SQLException
     */
    public static List<Map<String, Object>> getListFromRsLowerCase(ResultSet
                                                                           rs) throws
            SQLException {
        ...
        while (rs.next()) {
            Map<String, Object> map = new HashMap<String, Object>();
            for (i = 0; i < columns; i++) {
                map.put(md.getColumnName(i + 1).toLowerCase(), getValueByType
                        (rs, md.getColumnType(i + 1), md.getColumnName(i + 1)));
            }
            list.add(map);
        }
        return list;
     ...
     * @throws SQLException
     */
    public static List<Map<String, Object>> getListFromRsUpperCase(ResultSet
                                                                           rs) throws
            SQLException {
        ResultSetMetaData md = rs.getMetaData();
        int columns = md.getColumnCount();
        ...
        while (rs.next()) {
            Map<String, Object> map = new HashMap<String, Object>();
            for (i = 0; i < columns; i++) {
                map.put(md.getColumnName(i + 1).toUpperCase(), getValueByType
                        (rs, md.getColumnType(i + 1), md.getColumnName(i + 1)));
            }
            list.add(map);
        }
     ...
     * @throws SQLException
     */
    public static List<Object> getListFromRs(ResultSet rs, Class<?> c) throws
            SQLException {
     ...
     * @throws SQLException
     */
    public static Object getFirstObjectFromRs(ResultSet rs, Class<?> c)
            throws SQLException {
        Object o = null;
        try {
    ...
    private static Object getValueByType(ResultSet rs, int type, String name)
        ...
        switch (type) {
            ...
            case Types.TIMESTAMP:
                return rs.getTimestamp(name).toString().substring(0, rs
                        .getTimestamp(name).toString().length() - 2);
            case Types.INTEGER:
     ...
     * @throws SQLException
     */
    private static boolean rsContainsFields(ResultSet rs, String fieldName)
            throws SQLException {
        ResultSetMetaData md = rs.getMetaData();
     ...
     */
    private static Object initObjectFromRs(ResultSet rs, Class<?> c) throws
     ...
     * @throws InstantiationException
     */
    private static Object initObjectFromRsIfExist(ResultSet rs, Class<?> c)
     ...
     * @throws SQLException
     */
    private static Object getParamValueFromRs(ResultSet rs, Method m) throws
            SQLException {
     ...
     * @throws SQLException
     */
    private static Object getValueFromRs(ResultSet rs, String fieldName, Type
            t) throws SQLException {
        String type = t.toString();
        try {
            if (type.equals("int") || type.equals("class java.lang.Integer")) {
                return rs.getInt(fieldName);
            } else if (type.equals("float") || type.equals("class java.lang" +
                    ".Float")) {
                return rs.getFloat(fieldName);
            } else if (type.equals("double") || type.equals("class java.lang" +
                    ".Double")) {
                return rs.getDouble(fieldName);
            } else if (type.equals("long") || type.equals("class java.lang" +
                    ".Long")) {
        ...
        throw new RuntimeException("getValueFromRsByField fail, field type " +
                "is:" + type + ",field name is:" + fieldName);
    }
