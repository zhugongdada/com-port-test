...
public class httplogin {
    public static void main(String[] args) {
        // 登陆 Url
        String loginUrl = "http://192.168.0.40:2080/transnova-government-web/user/signin";
        // 需登陆后访问的 Url
        String dataUrl = "http://192.168.0.40:2080/transnova-government-web/driver/index/?";
        ...
        // 设置登陆时要求的信息，用户名和密码
        NameValuePair[] data = { new NameValuePair("loginName", "transnova"), new NameValuePair("loginPasswd", "123456") };
